...
# ===================================
# This is a TEMPLATE script - copy and modify it for your own integration.
...
# =============================================================================
# CONFIGURATION - Modify these constants for your integration
# =============================================================================

# Set to True if your API requires OAuth token exchange
USE_OAUTH = False

# Number of items to fetch per page (adjust based on your API's limits)
PAGE_SIZE = 100
...
def main(**kwargs):
    ...
    Receives standard parameters via kwargs:
    ...
    # Step 0: Get bearer token (optional, based on USE_OAUTH config)
    ...
    # Step 3: Fetch vulnerabilities from API
